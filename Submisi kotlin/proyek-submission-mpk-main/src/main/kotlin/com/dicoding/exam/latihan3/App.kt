...
fun <T> checkType(args: T): String {
   return when(args){
        ...
        else -> return "Data types is not available in here"
    }
    }
...
fun main() {
    println(
        ...
        '23' is Int? ${checkType(23)}
        '162.8' is Double? ${checkType(162.8)}
        "Uludag" to "Turkey" is map? ${checkType(mapOf("Uludag" to "Turkey"))}
    """.trimIndent()
    )
}
